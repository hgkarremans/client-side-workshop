...
export class TicketService {
  ...
  readonly tickets: Ticket[] = [
    { id: 1, title: 'Ticket 1', price: 10, date: new Date(), status: TicketStatus.active, seat: 1, owner: undefined },
    { id: 2, title: 'Ticket 2', price: 20, date: new Date(), status: TicketStatus.active, seat: 2, owner: undefined },
    { id: 3, title: 'Ticket 3', price: 30, date: new Date(), status: TicketStatus.inactive, seat: 3, owner: undefined },
    { id: 4, title: 'Ticket 4', price: 40, date: new Date(), status: TicketStatus.active, seat: 4, owner: undefined },
    { id: 5, title: 'Ticket 5', price: 50, date: new Date(), status: TicketStatus.inactive, seat: 5, owner: undefined },
    { id: 6, title: 'Ticket 6', price: 60, date: new Date(), status: TicketStatus.active, seat: 6, owner: undefined },
    { id: 7, title: 'Ticket 7', price: 70, date: new Date(), status: TicketStatus.inactive, seat: 7, owner: undefined },
  ];
  getTickets(): Ticket[] {
